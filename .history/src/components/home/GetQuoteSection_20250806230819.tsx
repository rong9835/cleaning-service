  ...
  return (
    <section className="hero w-full">
      <div className="relative h-[750px] lg:h-[600px]">
        ...
        <div className="absolute inset-0 flex flex-col lg:flex-row items-center justify-center lg:justify-between px-4 lg:px-24 xl:px-32 p-10 lg:pt-0">
          <div className="text-white max-w-lg mb-8 lg:mb-0 text-center lg:text-left px-2">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 leading-tight">
              Experience the Difference
              <br className="hidden sm:block" />
              <span className="sm:hidden"> </span>of a Professional Clean
            </h1>
          </div>
