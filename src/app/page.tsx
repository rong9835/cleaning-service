...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://jayannacleaningservice.com.au/logo/logo.png',
        width: 1920,
        height: 800,
      ...
      {
        url: 'https://jayannacleaningservice.com.au/images/main.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://jayannacleaningservice.com.au/logo/logo.png'],
  },
  alternates: {
