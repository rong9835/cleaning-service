...
export const metadata: Metadata = {
  ...
  description: 'Privacy policy for Jay & Anna Cleaning Service. Learn how we collect, use, and protect your personal information.',
};
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="space-y-8 text-gray-700">
        ...
        <section>
          ...
          <div className="space-y-3">
            <p className="leading-relaxed">
              [회사명] (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is committed to protecting your privacy.
            </p>
            <p className="leading-relaxed">
              This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website [웹사이트 도메인] and our services.
            </p>
            <p className="leading-relaxed">
              We are bound by the Australian Privacy Principles (APPs) contained in the Privacy Act 1988 (Cth) (&quot;Privacy Act&quot;).
              This policy is compliant with the NSW privacy laws and regulations.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Booking information (service type, date, time, special requests)</li>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">How We Collect Information</h2>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Other parties when you have given permission to third parties</li>
          </ul>
        </section>

        {/* Security of Your Information */}
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">Security of Your Information</h2>
          <div className="space-y-3">
            <p className="leading-relaxed">
        ...
        <section>
          ...
          <p className="mb-3">Under Australian privacy laws, you have the right to:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Access your personal information</li>
            <li>Correct inaccurate information</li>
            <li>Opt-out of marketing communications</li>
            <li>Request destruction or de-identifying of your personal information</li>
          </ul>
        </section>

        {/* Cookies and Tracking Technologies */}
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">Cookies and Tracking Technologies</h2>
          <p className="leading-relaxed">
            Our website may use cookies and similar tracking technologies to enhance your browsing
            experience. You can adjust your browser settings to refuse cookies, but this may affect your
        ...
        <section>
          ...
          <p className="leading-relaxed">
            ...
            posting the new Privacy Policy on our website. We recommend checking this policy
        ...
        <section className="bg-gray-50 p-6 rounded-lg">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              <li><strong>Email:</strong> [회사의 이메일]</li>
              <li><strong>Phone:</strong> [회사의 전화번호]</li>
              <li><strong>Address:</strong> [회사 주소]</li>
            </ul>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="leading-relaxed">
            If you believe we have breached the Australian Privacy Principles, you can make a complaint to
            us at the contact details above. If you are not satisfied with our response, you can contact the
